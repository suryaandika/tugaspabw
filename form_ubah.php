...
$ID=$_GET['ID'];
$sql= "SELECT * FROM Kabupaten WHERE ID='$ID'";
$query=mysqli_query($db,$sql);
$Kabupaten=mysqli_fetch_array($query);
?>

<h3>Form Ubah Kabupaten</h3>
<form method= "post" action= "proses_ubah.php?ID=<?=$ID?>">
<table width= "600" border= "0">

<tr>
<td width= "157">Nama Kabupaten </td>
<td width= "433"><input type= "text"
name= "nama_kabupaten" size= "30" value= "<?php echo $Kabupaten['nama_kabupaten'];?>"/>
...
size= "30" value= "<?php echo $Kabupaten['ibukota_kabupaten'];?>"/>
</td>
</tr>
...
<td>Luas Wilayah </td>
<td>
<input type="text" name="luas_wilayah" size="20" value="<?php echo $Kabupaten['luas_wilayah'];?>"/>
</td>
</tr>
