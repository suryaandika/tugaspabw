  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Daftar Kelurahan/Desa DI Provinsi Riau</h2>
        </div>
   ...
   <thead>
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM Kelurahan,Kecamatan WHERE Kelurahan.id_kecamatan = Kecamatan.id_kecamatan ";
        $query = mysqli_query($db, $sql);

        while($Kelurahan = mysqli_fetch_array($query)){
            echo "<tr>";

            echo "<td>".$Kelurahan['id_kelurahan']."</td>"; 
            echo "<td>".$Kelurahan['nama_kelurahan']."</td>";
            echo "<td>".$Kelurahan['jumlah_penduduk']."</td>";
            echo "<td>".$Kelurahan['nama_kecamatan']."</td>";
            echo "<td>"."<a href='edit_kelurahan.php?id_kelurahan=".$Kelurahan['id_kelurahan']."'>edit</td>"; 
            echo "<td>"."<a href='hapus_kelurahan.php?id_kelurahan=".$Kelurahan['id_kelurahan']."'>hapus</td>"; 
            echo "</tr>";
        }
        ?>
