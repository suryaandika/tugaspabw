    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Form Input Kelurahan/Desa</h2>
        </div>
...
if(isset($_POST['simpan'])){
    ...
    // buat query
    $sql = "INSERT INTO Kelurahan (nama_kelurahan, jumlah_penduduk, id_kecamatan ) VALUE ('$nama_kelurahan', '$jumlah_penduduk', '$id_kecamatan')";
